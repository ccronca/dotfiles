...
After the skill completes, use the summary to create an Obsidian journal entry in the myjournal vault at `Journal/Development/YYYY-MM-DD.md` with:
...
```
Tags: #development #workstream/pdm-db #dbt
```
